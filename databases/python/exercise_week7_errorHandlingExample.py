...
for i in range(1,numSailors+1):
	...
	print(aStatement)
	# One should use error handling so if sql throws an error you can continue one
	try:
		myc.execute(aStatement)
	except: 
		print("error trying to insert into sailors (" + str(anID) + " " + aName + str(anAge) + " " + aRating + "), hopefully continuing on....")
